...
!
      ...
      INTEGER :: NTRAIN, NLINES, NGROUPS, MEM, NMEM, MEM_START, MEM_END
      REAL,PARAMETER      :: PROJECTION=102.
!
      CHARACTER(LEN=100)        :: FCST_FILE, OBS_FILE, OUT_FILE
      CHARACTER(LEN=3)        :: NTRAIN_STR, NLINES_STR, NGROUPS_STR, MEM_STR
...
!
      ...
      INTEGER,DIMENSION(:), ALLOCATABLE :: DATE, GROUPS_MEM
...
!      GET COMMAND LINE ARG
      ...
      CALL GETARG(4, NTRAIN_STR)
      CALL GETARG(5, NLINES_STR)
      CALL GETARG(6, NGROUPS_STR)

      READ(NTRAIN_STR, '(I3)') NTRAIN
      READ(NLINES_STR, '(I3)') NLINES
      READ(NGROUPS_STR, '(I2)') NGROUPS
      ALLOCATE(GROUPS_MEM(NGROUPS))
      DO I = 7, 7+NGROUPS-1
          CALL GETARG(I, MEM_STR)
          READ(MEM_STR, '(I2)') MEM
          GROUPS_MEM(i-6) = MEM
      END DO
      NMEM = SUM(GROUPS_MEM(:))
